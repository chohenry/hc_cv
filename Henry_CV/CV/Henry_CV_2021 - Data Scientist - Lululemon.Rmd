...
tribble(
  ...
  "Master of Business Administration", "Simon Fraser University", "BC, Canada", "2021", "2021",
...
tribble(
  ...
  "Directed the development and delployment of a dashboard developed in R to monitor Covid testing volumes across various sites. The primary focus of the tool was to identify patterns of congestion from sample collection to results across the various testing locations.",
